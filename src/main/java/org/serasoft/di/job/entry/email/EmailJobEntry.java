 ...
 */
@JobEntry(
        id = "SeraEmailJobEntry",
        name = "EmailJobEntry.Name",
        description = "EmailJobEntry.TooltipDesc",
        image = "org/serasoft/di/job/entry/email/resources/MAIL.svg",
        i18nPackageName = "org.serasoft.di.job.entry.email",
        categoryDescription = "EmailJobEntry.Category"
)
public class EmailJobEntry extends JobEntryBase implements Cloneable, JobEntryInterface {
  ...
  public EmailJobEntry( String n ) {
    super( n, "" );
    allocate( 0 );
  }

  public EmailJobEntry() {
    this( "" );
    allocate( 0 );
  }
  ...
  public Object clone() {
    EmailJobEntry je = (EmailJobEntry) super.clone();
    if ( fileType != null ) {
  ...
  public String getDialogClassName() {
    return EmailJobEntry.class.getName();
  }
}
