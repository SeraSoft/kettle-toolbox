...
package org.serasoft.di.steps.excel;
...
@Step(
        id = "SeraExcelWriterStep",
        name = "ExcelWriter.Name",
        image = "org/serasoft/di/steps/excel/resources/XWS.svg",
        description = "ExcelWriter.TooltipDesc",
        i18nPackageName = "org.serasoft.di.steps.excel",
        categoryDescription = "ExcelWriter.Category"
)
@InjectionSupported( localizationPrefix = "ExcelWriterMeta.Injection." )
public class ExcelWriterStepMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name) {
    return new ExcelWriterStepDialog(shell, meta, transMeta, name);
  }
