...
package org.serasoft.di.steps.jsoninput;
 ...
 */
@Step(id = "EnhancedJsonInput"
        , image = "org/serasoft/di/steps/jsoninput/resources/JSI.svg"
        , name = "EnhancedJsonInput.name"
        , description = "EnhancedJsonInput.description"
        , i18nPackageName = "org.serasoft.di.steps.jsoninput"
        , categoryDescription = "EnhancedJsonInput.category")
public class JsonInputMeta extends
    ...
    public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name) {
        return new JsonInputDialog(shell, meta, transMeta, name);
    }
    /**
